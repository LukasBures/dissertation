...
def main(conf, segmentation_conf, image_dir, export_dir, as_half=False):
    logging.info('Extracting local features with configuration:'
                 f'\n{pprint.pformat(conf)}')
    logging.info('Segmenting local features with configuration:'
...
if __name__ == '__main__':
    ...
    parser.add_argument('--segmentation_conf', type=str, default='nvidia_segmentation_default',
                        choices=list(segmentation_confs.keys()))
