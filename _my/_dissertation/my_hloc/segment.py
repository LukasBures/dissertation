...
path_root = f"/home/lukas/PycharmProjects/Dissertation/_my/_dissertation/my_hloc/logs/{dataset}/{method}/{dn}/best_images"
print(f"Dataset: {dataset}, segmentation method:{method}, time: {dn}")
output_dst_root = f"/home/lukas/PycharmProjects/Dissertation/_my/_dissertation/my_hloc/logs/{dataset}/{method}/{dn}/{store_name}"
pickle_output_dst_root = f"/home/lukas/PycharmProjects/Dissertation/_my/_dissertation/my_hloc/logs/{dataset}/{method}/{dn}"
            ...
            if file.endswith(".png"):
                if "_input.png" in file:
                    ...
                    if toPickle:
                        tmp_dts = dts
                        foo = dict()
                        foo[f"{original_file_name}.jpg"] = {"nature": tmp_dts[f"{original_file_name}.jpg"]["vegetation"] | tmp_dts[f"{original_file_name}.jpg"]["terrain"]}
                        foo[f"{original_file_name}.jpg"].update({"sky": tmp_dts[f"{original_file_name}.jpg"]["sky"]})
                        foo[f"{original_file_name}.jpg"].update({"human": tmp_dts[f"{original_file_name}.jpg"]["person"] | tmp_dts[f"{original_file_name}.jpg"]["rider"]})
                        foo[f"{original_file_name}.jpg"].update({"vehicle": tmp_dts[f"{original_file_name}.jpg"]["car"] | tmp_dts[f"{original_file_name}.jpg"]["truck"] | tmp_dts[f"{original_file_name}.jpg"]["bus"] | tmp_dts[f"{original_file_name}.jpg"]["caravan"] | tmp_dts[f"{original_file_name}.jpg"]["trailer"] | tmp_dts[f"{original_file_name}.jpg"]["train"] | tmp_dts[f"{original_file_name}.jpg"]["motorcycle"] | tmp_dts[f"{original_file_name}.jpg"]["bicycle"] | tmp_dts[f"{original_file_name}.jpg"]["license plate"]})
                        dts.update(foo)
