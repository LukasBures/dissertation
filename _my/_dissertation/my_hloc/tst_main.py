...
parser.add_argument('--images', type=str, default='/home/lukas/PycharmProjects/Dissertation/datasets/aachen/images/images_upright/')
parser.add_argument('--pairs', type=str, default='/home/lukas/PycharmProjects/Dissertation/HierarchicalLocalization/pairs/aachen/')
...
parser.add_argument('--covisibility_clustering', type=str2bool, nargs='?', const=True, default=False, help='covisibility clustering in localize_sfm.py')
...
localize_sfm.main(
    ...
    loc_match_path,
    results,
    covisibility_clustering=args.covisibility_clustering)  # not required with SuperPoint+SuperGlue
