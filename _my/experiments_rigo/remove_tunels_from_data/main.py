    ...
    for s in seasons:
        ...
        for d in data:
            ...
            if sum_img < 50:
                ...
                # spring
                shutil.move(
                    d.replace("winter", "spring"),
                    d.replace("winter", "spring").replace("nordlandsbanen_imgs", "nordlandsbanen_imgs/tunnels"),
                )
                # summer
                shutil.move(
                    d.replace("winter", "summer"),
                    d.replace("winter", "summer").replace("nordlandsbanen_imgs", "nordlandsbanen_imgs/tunnels"),
                )
                # fall
                shutil.move(
                    d.replace("winter", "fall"),
                    d.replace("winter", "fall").replace("nordlandsbanen_imgs", "nordlandsbanen_imgs/tunnels"),
                )
