...
new_features_pth = Path("/data512/dissertation_results/aachen-2021.12.13_17.32.10/results/new_feats-superpoint-n4096-r1024.h5")
sfm_matches = Path("/data512/dissertation_results/aachen-2021.12.13_17.32.10/results/feats-superpoint-n4096-r1024_matches-superglue_pairs-db-covis20.h5")

# with h5py.File(str(sfm_matches), 'r') as fo:
#    print(fo.keys())

triangulation.main(reference_sfm, sift_sfm, images, sfm_pairs, new_features_pth, sfm_matches, colmap_path="colmap", skip_geometric_verification=True, verbose=False)
