...
run: int = 2
dataset_name: str = "4Seasons, test1"
print(f"\n{dataset_name} - EXPERIMENT RUN {run}\n")

# Experiment 1 - 4Seasons-2022.02.09_21.28.45
experiment_1: str = "/home/lukas/PycharmProjects/dissertation/_my/dissertation/my_hloc/result_graphs/4Seasons/results_reloc/lukas_bures_exp1/test1_results"

# Experiment 2 - 4Seasons-2022.02.12_15.28.29
experiment_2: str = "/home/lukas/PycharmProjects/dissertation/_my/dissertation/my_hloc/result_graphs/4Seasons/results_reloc/lukas_bures_exp2/test1_results"
