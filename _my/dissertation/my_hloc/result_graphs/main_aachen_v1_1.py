...
results_without_dynamic_kp_run3: List[dict] = [
    {
        ...
        "dynamic_percentage": 0,
        "day": "62.0 / 72.5 / 81.4",
        "night": "22.0 / 31.4 / 41.9",
    },
    {
        "static_percentage": 10,
        "dynamic_percentage": 0,
        "day": "75.6 / 85.6 / 92.5",
        "night": "50.3 / 66.5 / 83.8",
    },
    {
        "static_percentage": 15,
        "dynamic_percentage": 0,
        "day": "79.4 / 89.2 / 94.9",
        "night": "58.6 / 81.7 / 93.7",
    },
    {
        "static_percentage": 20,
        "dynamic_percentage": 0,
        "day": "82.8 / 91.4 / 95.9",
        "night": "65.4 / 84.3 / 96.9",
    },
    {
        "static_percentage": 25,
        "dynamic_percentage": 0,
        "day": "82.9 / 91.1 / 96.7",
        "night": "69.1 / 86.4 / 97.4",
    },
    {
        "static_percentage": 30,
        "dynamic_percentage": 0,
        "day": "84.7 / 92.5 / 97.1",
        "night": "69.1 / 88.0 / 97.9",
    },
    {
        "static_percentage": 35,
        "dynamic_percentage": 0,
        "day": "84.7 / 93.0 / 97.5",
        "night": "70.7 / 86.9 / 98.4",
    },
    {
        "static_percentage": 40,
        "dynamic_percentage": 0,
        "day": "84.3 / 93.1 / 97.6",
        "night": "70.2 / 87.4 / 97.9",
    },
    {
        "static_percentage": 45,
        "dynamic_percentage": 0,
        "day": "86.3 / 93.7 / 97.6",
        "night": "71.7 / 88.5 / 98.4",
    },
    {
        "static_percentage": 50,
        "dynamic_percentage": 0,
        "day": "85.7 / 93.1 / 97.7",
        "night": "72.3 / 87.4 / 98.4",
    },
    {
        "static_percentage": 55,
        "dynamic_percentage": 0,
        "day": "85.2 / 93.4 / 97.7",
        "night": "71.7 / 89.0 / 98.4",
    },
    {
        "static_percentage": 60,
        "dynamic_percentage": 0,
...
results_with_dynamic_kp_run3: List[dict] = [
    {
        ...
        "dynamic_percentage": 100,
        "day": "59.7 / 72.8 / 82.8",
        "night": "28.3 / 42.4 / 49.7",
    },
    {
        "static_percentage": 10,
        "dynamic_percentage": 100,
        "day": "74.9 / 85.0 / 92.4",
        "night": "53.4 / 73.3 / 85.3",
    },
    {
        "static_percentage": 15,
        "dynamic_percentage": 100,
        "day": "80.9 / 89.2 / 95.4",
        "night": "61.3 / 80.1 / 93.7",
    },
    {
        "static_percentage": 20,
        "dynamic_percentage": 100,
        "day": "82.5 / 89.9 / 95.6",
        "night": "63.4 / 81.7 / 95.8",
    },
    {
        "static_percentage": 25,
        "dynamic_percentage": 100,
        "day": "82.2 / 91.3 / 96.8",
        "night": "70.7 / 88.0 / 96.9",
    },
    {
        "static_percentage": 30,
        "dynamic_percentage": 100,
        "day": "84.7 / 92.0 / 96.7",
        "night": "64.4 / 83.8 / 97.4",
    },
    {
        "static_percentage": 35,
        "dynamic_percentage": 100,
        "day": "84.5 / 92.6 / 97.2",
        "night": "71.7 / 86.9 / 97.4",
    },
    {
        "static_percentage": 40,
        "dynamic_percentage": 100,
...
plt.title(f"{dataset_name}, query, day, all thresholds")
plt.xlabel("% of kept static keypoints")
plt.ylabel("% of successfully localized images")
plt.legend(
    [
        "0.25m and 2°, with dynamic KPs",
        "0.50m and 5°, with dynamic KPs",
        "5.00m and 10°, with dynamic KPs",
        "0.25m and 2°, without dynamic KPs",
        "0.50m and 5°, without dynamic KPs",
        "5.00m and 10°, without dynamic KPs",
    ],
    title="Thresholds:",
    loc=4,
)
...
plt.savefig(f"plots/{dataset_name.replace(' ', '_').replace(',', '').replace('.', '')}_day_run{run}.pdf")
...
for i in range(0, 3):
    ...
    plt.title(f"{dataset_name}, query, day, threshold: {limit:2.2f}m and {angle}°")
    plt.xlabel("% of kept static keypoints")
    plt.ylabel("% of successfully localized images")
    plt.legend(
        [
            f"{limit:2.2f}m and {angle}°, with dynamic KPs",
            f"{limit:2.2f}m and {angle}°, without dynamic KPs",
        ],
        title="Threshold:",
        loc=4,
    )
    ...
    # plt.yticks(np.arange(0, 101, 10))
    plt.grid(axis="both", color="0.95")
    plt.savefig(f"plots/{dataset_name.replace(' ', '_').replace(',', '').replace('.', '')}_{f'{limit:2.2f}'.replace('.','')}m_{angle}_run{run}.pdf")
